...
public abstract class NanoHTTPD {
    ...
    public void start() throws IOException {
    	...
    	// SSL Here
    	//https://github.com/bndtools/bnd/blob/master/biz.aQute.repository/src/test/lib/NanoHTTPD.java
    	//http://csoap.sourceforge.net/docs/snapshot/libsoap-doc-api/html/nanohttp_ssl_page.html#nanohttp_ssl_configuration_sec
    	//https://sites.google.com/site/ssljavaguide/java-ssl-basics
        ...
        myThread = new Thread(new Runnable() {
            ...
            public void run() {
                do {
                    try {
                    	final long id = myThread.getId();
                        final Socket finalAccept = myServerSocket.accept();                         
                        InputStream inputStream = finalAccept.getInputStream();
                        OutputStream outputStream = finalAccept.getOutputStream();                        
                    	String remote_address = finalAccept.getRemoteSocketAddress().toString().split(":")[0].replace("/","");
                        TempFileManager tempFileManager = tempFileManagerFactory.create();                        
                        final HTTPSession session = new HTTPSession(tempFileManager, inputStream, outputStream, remote_address);
    ...
    public abstract Response serve(String uri, Method method, Map<String, String> header, Map<String, String> parms,
                                   Map<String, String> files, String remote_address, long pid);
    ...
    public static class Response {
        ...
        public Response(Status status, String mimeType, String txt) {
            ...
            this.mimeType = mimeType;
            try {
                this.data = new ByteArrayInputStream( txt.getBytes("UTF-8") ); //txt.getBytes("ISO-8859-1"));
    ...
    protected class HTTPSession implements Runnable {
        ...
        public HTTPSession(TempFileManager tempFileManager, InputStream inputStream, OutputStream outputStream, String remote_address) {
        ...
        public void run() {
            try {
                ...
                // Ok, now do the serve()
                Response r = serve(uri, method, header, parms, files, remote_address, threadId);
                if (r == null) {
