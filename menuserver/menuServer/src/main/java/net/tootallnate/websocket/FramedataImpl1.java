...
public class FramedataImpl1 implements FrameBuilder {
	...
	public String toString( ) {
		...
		try {
			unmasked = new String ( unmaskedpayload.array () , "UTF8" );
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		return "Framedata{ optcode:" + getOpcode() + ", fin:" + isFin() + ", masked:" + getTransfereMasked() +", payloadlength:"+unmaskedpayload.limit()+", payload:" + unmasked + "}" ;
	}
