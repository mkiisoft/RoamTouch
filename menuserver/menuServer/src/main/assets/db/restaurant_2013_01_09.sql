...
CREATE TABLE "orders" ("_id" INTEGER PRIMARY KEY AUTOINCREMENT  NOT NULL , "date" DATETIME NOT NULL , "dining_table_id" INTEGER NOT NULL , "total" DOUBLE NOT NULL , "observation" TEXT NOT NULL,  "order_status_id" INTEGER NOT NULL , "created_at" TIMESTAMP NOT NULL , "updated_at" DATETIME NOT NULL, FOREIGN KEY(dining_table_id) REFERENCES dining_tables(_id), FOREIGN KEY(order_status_id) REFERENCES order_status(_id));
INSERT INTO "orders" VALUES(1,'2013-01-09',1,100,'ojo con los tiempos',1,'2013-01-09','2013-01-09');
INSERT INTO "orders" VALUES(2,'2013-01-09',2,150,'ninguna',2,'2013-01-09','2013-01-09');
