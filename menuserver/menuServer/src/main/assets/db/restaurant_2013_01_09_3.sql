...
CREATE TABLE "menus" ("_id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "description" TEXT NOT NULL, "folder_name" TEXT NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" DATETIME NOT NULL );
INSERT INTO "menus" VALUES(1,'Menú Mañana','menu_manana','2013-01-01','2013-01-01');
INSERT INTO "menus" VALUES(2,'Menú Mediodía','menu_mediodia','2013-01-02','2013-01-02');
INSERT INTO "menus" VALUES(3,'Menú Tarde','menu_tarde ','2013-01-04','2013-01-04');
INSERT INTO "menus" VALUES(4,'Menú Noche','menu_noche','2013-01-07','2013-01-07');
...
INSERT INTO "categories" VALUES(12,'Desayuno',1,'desayuno','2013-01-09','2013-01-09');
INSERT INTO "categories" VALUES(13,'Sandwiches',1,'sandwiches','2013-01-09','2013-01-09');
...
CREATE TABLE "dining_tables" ("_id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "observation" TEXT NOT NULL, "dining_table_status_id" INTEGER NOT NULL  , "created_at" TIMESTAMP NOT NULL , "updated_at" DATETIME NOT NULL, FOREIGN KEY(dining_table_status_id) REFERENCES dining_table_status(_id));
INSERT INTO "dining_tables" VALUES(1,'nada',1,'2013-01-09','2013-01-09');
INSERT INTO "dining_tables" VALUES(2,'nada',2,'2013-01-09','2013-01-09');
...
CREATE TABLE "orders" ("_id" INTEGER PRIMARY KEY AUTOINCREMENT  NOT NULL , "date" DATETIME NOT NULL , "dining_table_id" INTEGER NOT NULL, "observation" TEXT NOT NULL,  "order_status_id" INTEGER NOT NULL, "total" DOUBLE NOT NULL  , "created_at" TIMESTAMP NOT NULL , "updated_at" DATETIME NOT NULL, FOREIGN KEY(dining_table_id) REFERENCES dining_tables(_id), FOREIGN KEY(order_status_id) REFERENCES order_status(_id));
INSERT INTO "orders" VALUES(1,'2013-01-09',1,'ojo con los tiempos',1,100,'2013-01-09','2013-01-09');
INSERT INTO "orders" VALUES(2,'2013-01-09',2,'ninguna',2,'85,50','2013-01-09','2013-01-09');
INSERT INTO "orders" VALUES(3,'2013-01-09',2,'paga con debito',3,75.3,'2013-01-09','2013-01-09');
INSERT INTO "orders" VALUES(4,'2013-01-09',2,'persona celiaca',4,75.3,'2013-01-09','2013-01-09');
