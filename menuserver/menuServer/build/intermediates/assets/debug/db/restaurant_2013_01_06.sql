...
CREATE TABLE "categories" ("_id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "description" TEXT NOT NULL , "menu_id" INTEGER NOT NULL , "created_at" TIMESTAMP NOT NULL, "updated_at" DATETIME NOT NULL, FOREIGN KEY(menu_id) REFERENCES menu(_id));
INSERT INTO "categories" VALUES(2,'Entrada',2,'2013-01-01','2013-01-01');
INSERT INTO "categories" VALUES(3,'Plato Principal',2,'2013-01-01','2013-01-01');
INSERT INTO "categories" VALUES(4,'Postre',2,'2013-01-01','2013-01-01');
INSERT INTO "categories" VALUES(5,'Bebidas sin Alcohol',2,'2013-01-01','2013-01-01');
INSERT INTO "categories" VALUES(6,'Bebidas con Alcohol',2,'2013-01-01','2013-01-01');
INSERT INTO "categories" VALUES(7,'Entrada',4,'2013-01-01','2013-01-01');
INSERT INTO "categories" VALUES(8,'Plato Principal',4,'2013-01-01','2013-01-01');
INSERT INTO "categories" VALUES(9,'Postre',4,'2013-01-01','2013-01-01');
INSERT INTO "categories" VALUES(10,'Bebidas sin Alcohol',4,'2013-01-01','2013-01-01');
INSERT INTO "categories" VALUES(11,'Bebidas con Alcohol',4,'2013-01-01','2013-01-01');
