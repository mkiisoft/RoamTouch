...
var jSSC = {
	 ...
	 */
    init: function() {
    	var appletStr_jss = '<applet name="jssc_bridge" id="jssc_bridge" code="jssc.bridge.JSBridge" archive="../printing/jSSC-Bridge-2.1.jar, ../printing/lib/jssc.jar" width="0" height="0">' +
    						'<param name="separate_jvm" value="true">' +
        					'<param name="mayscript" value="yes">' +
        					'<param name="scriptable" value="true">' +
        				'</applet>';
    	document.getElementById('jssc_init').innerHTML = appletStr_jss;
